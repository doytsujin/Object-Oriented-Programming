...
public class Food {
	 ...
	 */
	private Map<String,NutritionalElement> rawmap=new TreeMap<>();
	private Map<String,NutritionalElement> prodmap=new TreeMap<>();
	protected Map<String,NutritionalElement> recpmap=new TreeMap<>();
	...
	public void defineRawMaterial(String name,
									  ...
									  double carbs,
									  double fat){
		rawmap.put(name, new Rawelements(name,calories,proteins,carbs,fat));
		return;
	}
	...
	public void defineProduct(String name,
								  ...
								  double carbs,
								  double fat){
		prodmap.put(name, new Products(name,calories,proteins,carbs,fat));
		return;
	}
